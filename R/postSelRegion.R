...
#' @param sel_region A dataframe object. Can be generated from function selectRegion.
#'
...
#' 
#' sel_region <- data.frame("node" = seq(10), 
#'                          "node_x" = seq(10), 
#'                          "node_y" = seq(10))
#' 
...
postSelRegion <- function(spe, sel_region){
  ...
  components <- S4Vectors::DataFrame(data.frame("component" = "user_defined",
