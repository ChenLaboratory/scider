...
#' @param roi Character value. By default is all. The specific ROIs to be plotted.
#' @param cell.type Character value. By default is all. The cell types to be plotted.
...
plotCorHeatmap <- function(model.result,
  ...
  paletteLength <- 100
  hmColor <- rev(colorRampPalette(c(
    "#ED254EFF", "#EF6079FF",
    "#F1F4FFFF", "#97B3D0FF",
    "#011936FF"
  ))(paletteLength))
